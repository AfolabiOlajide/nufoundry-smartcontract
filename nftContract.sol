...
contract NuSeriesFansCollection is ERC721A, Ownable {
    ...
    constructor() payable ERC721A("Nu Series Fans Collection", "NUFANS") {
        publicMintPrice = 0.0002 ether;
        whitelistMintPrice = 0.0001 ether;
        totalMinted = 0;
        maxSupply = 5000;
        maxMintAmount = maxSupply - totalMinted;
        publicMintLimit = 1;
        whitelistMintLimit = 3;
        placeholderUri = "ipfs://QmTXLAMqVN4N9pZ874Kwf3rKi2uqLgCNw9o95Z8xGmXd7D/placeholder.json";
    }
